...
func GetAntigravityModelConfig() map[string]*AntigravityModelConfig {
	return map[string]*AntigravityModelConfig{
		...
		"gemini-3.1-pro-high":         {Thinking: &ThinkingSupport{Min: 128, Max: 65535, ZeroAllowed: false, DynamicAllowed: true, Levels: []string{"low", "medium", "high"}}},
		...
		"gpt-oss-120b-medium":         {},
		"tab_flash_lite_preview":      {MaxCompletionTokens: 4096},
		"tab_jump_flash_lite_preview": {MaxCompletionTokens: 4096},
	}
}
...
func GetGeminiCLIModelConfig() map[string]*GeminiCLIModelConfig {
	return map[string]*GeminiCLIModelConfig{
		...
		"gemini-3.1-pro-preview": {Thinking: &ThinkingSupport{Min: 128, Max: 32768, ZeroAllowed: false, DynamicAllowed: true, Levels: []string{"low", "medium", "high"}}},
	}
}
